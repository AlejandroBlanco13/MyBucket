  ...
  return (
    <div className="fixed inset-0 overflow-hidden bg-black text-white">
      <div
        ...
        style={{ backgroundImage: `url(${alejandriaBackground})` }}
        aria-hidden
      />
      <div
        className="absolute inset-0 bg-gradient-to-b from-black/75 via-black/70 to-black/90"
        aria-hidden
      />
      ...
      <main className="relative z-10 flex h-full flex-col justify-center px-5 py-12 md:px-8 md:py-16">
        <div className="mx-auto w-full max-w-content">
          ...
          <RealmRail onSelect={onSelect} locked={activeRealm !== null} />
